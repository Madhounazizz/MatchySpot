...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 16, color: colors.textLight, marginTop: 4, fontWeight: '600' },
  filterButton: {
    width: 52,
    height: 52,
    borderRadius: 26,
  ...
  metricCard: { backgroundColor: colors.white, borderRadius: 32, padding: 28, width: cardWidth, ...shadows.large, elevation: 10 },
  ...
  statRow: { flexDirection: 'row', backgroundColor: colors.white, borderRadius: 32, padding: 32, ...shadows.large, elevation: 10, borderLeftWidth: 6, borderLeftColor: colors.secondary },
